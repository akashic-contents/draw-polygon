...
interface LineData {
	begin: box2d.Box2DWeb.Common.Math.b2Vec2;
	end: box2d.Box2DWeb.Common.Math.b2Vec2;
}
 ...
 */
function createLine(scene: g.Scene, line: LineData, weight: number, color: string): g.FilledRect {
 ...
 */
function createPolygon(scene: g.Scene, vertices: box2d.Box2DWeb.Common.Math.b2Vec2[]): void {
 ...
 */
function crossPoint(line1: LineData, line2: LineData): box2d.Box2DWeb.Common.Math.b2Vec2 | null {
	const a = line1.begin;
	const b = line1.end;
	const c = line2.begin;
	const d = line2.end;
